...
function pixe_import_files() {
    return array(
        ...
        array(
            'import_file_name'             => esc_html__('Creative Agency Demo 2' , 'gentium'),
            'import_file_url'              => 'https://www.dropbox.com/s/qq5b4whylvcw82h/demo-creative2.xml?dl=1',
            'import_customizer_file_url'   => 'https://www.dropbox.com/s/4cw4qkka5v3bl1x/customizer-export.dat?dl=1',
            'import_preview_image_url'     => 'https://dl.dropbox.com/s/r9f2nsjucopwz79/creative-agency%202.png',
            'preview_url'                  => 'http://gentium.pixerex.com/wp/creative2/',
        ),

        array(
            'import_file_name'             => esc_html__('Studio Demo 2' , 'gentium'),
            'import_file_url'              => 'https://www.dropbox.com/s/l1m5xbicxctfggk/demo-studio2.xml?dl=1',
            'import_customizer_file_url'   => 'https://www.dropbox.com/s/4cw4qkka5v3bl1x/customizer-export.dat?dl=1',
            'import_preview_image_url'     => 'https://dl.dropbox.com/s/ncutj7j0xmljk8d/studio2.png',
            'preview_url'                  => 'http://gentium.pixerex.com/wp/studio2/',
        ),

        array(
            'import_file_name'             => esc_html__('Agency Dark Demo' , 'gentium'),
            'import_file_url'              => 'https://www.dropbox.com/s/oj1hvwcvez542fg/demo-agency-dark.xml?dl=1',
            'import_customizer_file_url'   => 'https://www.dropbox.com/s/4cw4qkka5v3bl1x/customizer-export.dat?dl=1',
            'import_preview_image_url'     => 'https://dl.dropbox.com/s/g5xpslgudjy3i3s/agency-dark.png',
            'preview_url'                  => 'http://gentium.pixerex.com/wp/agency-dark/',
        ),

        array(
            'import_file_name'             => esc_html__('Startup Demo 2' , 'gentium'),
            'import_file_url'              => 'https://www.dropbox.com/s/djkkji753846lkt/demo-startup2.xml?dl=1',
            'import_customizer_file_url'   => 'https://www.dropbox.com/s/4cw4qkka5v3bl1x/customizer-export.dat?dl=1',
            'import_preview_image_url'     => 'https://dl.dropbox.com/s/o9osi939tte2qwn/startup2.png',
            'preview_url'                  => 'http://gentium.pixerex.com/wp/startup2/',
        ),

        array(
            'import_file_name'             => esc_html__('Startup Demo 3' , 'gentium'),
            'import_file_url'              => 'https://www.dropbox.com/s/ujmbj31z7lpg7hv/demo-startup3.xml?dl=1',
            'import_customizer_file_url'   => 'https://www.dropbox.com/s/4cw4qkka5v3bl1x/customizer-export.dat?dl=1',
            'import_preview_image_url'     => 'https://dl.dropbox.com/s/1lf25ssg2ngtr84/startup3.png',
            'preview_url'                  => 'http://gentium.pixerex.com/wp/startup2/',
        ),

        array(
            'import_file_name'             => esc_html__('Design Agency Demo' , 'gentium'),
            'import_file_url'              => 'https://www.dropbox.com/s/og94csvvywkawlo/demo-design-agency.xml?dl=1',
            'import_customizer_file_url'   => 'https://www.dropbox.com/s/4cw4qkka5v3bl1x/customizer-export.dat?dl=1',
            'import_preview_image_url'     => 'https://dl.dropbox.com/s/yias6x0lujdhhqo/design-agency.jpg',
            'preview_url'                  => 'http://gentium.pixerex.com/wp/design-agency/',
        ),
    );
}
